...
class Script(scripts.Script):
    ...
    def depthmap(self, image_init: Image.Image, image_map: Image.Image, model: str, strength: float, invert: bool):
        ...
        return image_init.to(devices.device), image_map.to(devices.device)
    ...
    def run(self, p: processing.StableDiffusionProcessingImg2Img, enabled, strength, invert, model, image): # pylint: disable=arguments-differ
        ...
        image_init, image_map = self.depthmap(p.init_images[0], image, model, strength, invert)
        ...
        try:
            ...
            shared.log.debug(f'Differential-diffusion: pipeline={pipe.__class__.__name__} strength={strength} model={model} image={image_init.shape} map={image_map.shape}')
