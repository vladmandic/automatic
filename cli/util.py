...
def get_memory():
    ...
    try:
        ...
        if torch.cuda.is_available():
            ...
            allocated = {
                "current": gb(s["allocated_bytes.all.current"]),
                "peak": gb(s["allocated_bytes.all.peak"]),
            }
            reserved = {
                "current": gb(s["reserved_bytes.all.current"]),
                "peak": gb(s["reserved_bytes.all.peak"]),
            }
            active = {
                "current": gb(s["active_bytes.all.current"]),
                "peak": gb(s["active_bytes.all.peak"]),
            }
            inactive = {
                "current": gb(s["inactive_split_bytes.all.current"]),
                "peak": gb(s["inactive_split_bytes.all.peak"]),
            }
