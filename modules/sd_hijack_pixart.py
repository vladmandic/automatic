# copied from https://github.com/PixArt-alpha/PixArt-sigma/blob/master/scripts/diffusers_patches.py

from typing import Callable, List, Optional, Tuple, Union
import torch
from diffusers import ImagePipelineOutput, PixArtAlphaPipeline, AutoencoderKL, Transformer2DModel, DPMSolverMultistepScheduler
...
def pipeline_pixart_alpha_call(
    ...
    device = self._execution_device # pylint: disable=protected-access
...
def patch_pixart_sigma_transformer():
    setattr(Transformer2DModel, '_init_patched_inputs', pixart_sigma_init_patched_inputs) # noqa:B010
