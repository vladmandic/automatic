...
options_templates.update(options_section(('sd', "Stable Diffusion"), {
    ...
    "cross_attention_optimization": OptionInfo("Sub-quadratic" if is_device_dml "InvokeAI's" if cmd_opts.use_ipex else "Scaled-Dot-Product", "Cross-attention optimization method", gr.Radio, lambda: {"choices": shared_items.list_crossattention() }),
