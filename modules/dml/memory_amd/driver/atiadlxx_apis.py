...
if "Windows" in platform():
    ...
    atiadlxx = C.CDLL(
        "libatiadlxx.so"
    )  # Not tested on Linux system. But will be supported.
...
ADL2_Adapter_MemoryInfo2_Get.argtypes = [
    ADL_CONTEXT_HANDLE,
    C.c_int,
    C.POINTER(ADLMemoryInfo2),
]
...
ADL2_Adapter_DedicatedVRAMUsage_Get.argtypes = [
    ADL_CONTEXT_HANDLE,
    C.c_int,
    C.POINTER(C.c_int),
]
