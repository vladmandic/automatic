...
def _make_causal_mask(
    ...
    mask = torch.full(
        (tgt_len, tgt_len), min, device=device
    )  # https://discord.com/channels/1101998836328697867/1127441997184122920
...
transformers.models.clip.modeling_clip.CLIPTextEmbeddings.forward = (
    CLIPTextEmbeddings_forward
)
