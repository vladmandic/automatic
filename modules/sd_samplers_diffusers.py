...
samplers_data_diffusers = [
    ...
    sd_samplers_common.SamplerData(
        "UniPC",
        lambda model: DiffusionSampler("UniPC", UniPCMultistepScheduler, model),
        [],
        {},
    ),
    sd_samplers_common.SamplerData(
        "DEIS",
        lambda model: DiffusionSampler("DEIS", DEISMultistepScheduler, model),
        [],
        {},
    ),
    sd_samplers_common.SamplerData(
        "PNDM", lambda model: DiffusionSampler("PNDM", PNDMScheduler, model), [], {}
    ),
    sd_samplers_common.SamplerData(
        "DDPM", lambda model: DiffusionSampler("DDPM", DDPMScheduler, model), [], {}
    ),
    sd_samplers_common.SamplerData(
        "DDIM", lambda model: DiffusionSampler("DDIM", DDIMScheduler, model), [], {}
    ),
    sd_samplers_common.SamplerData(
        "LMSD",
        lambda model: DiffusionSampler("LMSD", LMSDiscreteScheduler, model),
        [],
        {},
    ),
    sd_samplers_common.SamplerData(
        "KDPM2",
        lambda model: DiffusionSampler("KDPM2", KDPM2DiscreteScheduler, model),
        [],
        {},
    ),
    sd_samplers_common.SamplerData(
        "KDPM2 a",
        lambda model: DiffusionSampler(
            "KDPM2 a", KDPM2AncestralDiscreteScheduler, model
        ),
        [],
        {},
    ),
    sd_samplers_common.SamplerData(
        "DPM 1S",
        lambda model: DiffusionSampler("DPM++ 1S", DPMSolverSinglestepScheduler, model),
        [],
        {},
    ),
    sd_samplers_common.SamplerData(
        "DPM 2M",
        lambda model: DiffusionSampler("DPM++ 2M", DPMSolverMultistepScheduler, model),
        [],
        {},
    ),
    sd_samplers_common.SamplerData(
        "Euler",
        lambda model: DiffusionSampler("Euler", EulerDiscreteScheduler, model),
        [],
        {},
    ),
    sd_samplers_common.SamplerData(
        "Euler a",
        lambda model: DiffusionSampler(
            "Euler a", EulerAncestralDiscreteScheduler, model
        ),
        [],
        {},
    ),
    sd_samplers_common.SamplerData(
        "Heun",
        lambda model: DiffusionSampler("Heun", HeunDiscreteScheduler, model),
        [],
        {},
    ),
]
...
class DiffusionSampler:
    def __init__(self, name, constructor, model, **kwargs):
        ...
        for key, value in config.get(
            name, {}
        ).items():  # apply diffusers per-scheduler defaults
