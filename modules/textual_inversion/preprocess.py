...
def save_pic(
    image, index, params, existing_caption=None, existing_caption_filename=None
):
    save_pic_with_caption(
        ...
        existing_caption_filename=existing_caption_filename,
    )
    if params.flip:
        save_pic_with_caption(
...
def multicrop_pic(image: Image, mindim, maxdim, minarea, maxarea, objective, threshold):
    iw, ih = image.size
    err = lambda w, h: 1 - (lambda x: x if x < 1 else 1 / x)(
        iw / ih / (w / h)
